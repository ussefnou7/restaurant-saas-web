export const expensesAr = {
  'expenses.shift.label': 'الوردية التي دُفع منها',
  'expenses.shift.none': 'بدون ربط بوردية',
  'expenses.shift.branchRequired': 'اختر فرعًا لربط المصروف بوردية درج النقد.',
  'expenses.shift.empty': 'لا توجد ورديات في هذه الفترة. وسّع الفترة للبحث عن ورديات أقدم.',
  'expenses.shift.window': 'فترة البحث',
  'expenses.shift.days': 'آخر {{days}} أيام',
  'expenses.shift.loading': 'جارٍ تحميل الورديات…',
  'expenses.shift.retry': 'إعادة تحميل الورديات',
  'expenses.shift.stillOpen': 'مفتوحة حتى الآن',
  'expenses.shift.closedWarning': 'مغلقة — سيتم ربط المصروف بها، لكن الفرق المسجل عند الإغلاق لن يتغير.',
  'expenses.shift.optional': 'اختياري. اختر وردية درج النقد التي دُفع منها هذا المصروف.',
  ...
  'expenses.categories.filters.search': 'البحث في اسم التصنيف...',
  'expenses.categories.scope': 'النوع',
  'expenses.categories.scopeAll': 'جميع الأنواع',
  ...
  // Details Page
  'expenses.detail.title': 'مصروف رقم #{{id}}',
  'expenses.detail.back': 'العودة إلى المصروفات',
  'expenses.detail.info': 'بيانات المصروف',
  'expenses.detail.audit': 'بيانات التدقيق',
  'expenses.detail.createdAt': 'وقت التسجيل',
  'expenses.detail.createdBy': 'سُجّل بواسطة',
  'expenses.detail.voidInfo': 'أثر الإلغاء (منع التلاعب)',
  'expenses.detail.voidedAt': 'وقت الإلغاء',
  'expenses.detail.voidedBy': 'أُلغي بواسطة',
  'expenses.detail.viewDetails': 'عرض التفاصيل',
  'expenses.detail.notFound': 'المصروف غير موجود',
